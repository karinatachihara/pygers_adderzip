...
for eachParti in range(5,25):
    ...
    for eachRun in range (1,13):
        ...
        n_trig = data.count("Keypress: equal")
        
        #print('Number of triggers :', occurrences)
        
        partiData[eachRun-1,1] = n_trig

    np.savetxt(path+'/data/behavioral/data_10_15_21/triggerCount/triggerCount_'+sub+'.csv', partiData, fmt='%f', delimiter=",", header = 'run,triggerCount')
